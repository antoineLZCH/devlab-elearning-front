        ...
        <div class="bg-gray-300 fixed w-32 h-full min-h-screen">
          <div class="xl:py-2">
            <div class="group relative sidebar-item with-children">
              <nuxt-link to="/" class="block xl:flex xl:items-center text-center xl:text-left shadow-light xl:shadow-none py-6 xl:py-2 xl:px-4 border-l-4 border-transparent hover:bg-gray-700 hover:text-white flex justify-center items-center">
            ...
            <div class="group relative sidebar-item with-children">
              <nuxt-link to="/formation" class="block xl:flex xl:items-center text-center xl:text-left shadow-light xl:shadow-none py-6 xl:py-2 xl:px-4 border-l-4 border-transparent hover:bg-gray-700 hover:text-white flex justify-center items-center">
